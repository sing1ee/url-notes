...
## [nicekate/AI-ContentCraft: AI ContentCraft is an all-in-one content creation suite that helps creators generate stories, podcast scripts, and multimedia content using AI-powered text generation, speech synthesis, and image generation capabilities.](https://github.com/nicekate/AI-ContentCraft)
...
## [GoCodeo - 终极 AI 编程助手 | Product Hunt --- GoCodeo - The Ultimate AI Coding Agent | Product Hunt](https://www.producthunt.com/posts/gocodeo-2)
...
## [Doriandarko/RAT-retrieval-augmented-thinking: RAT is a powerful tool that improves AI responses by leveraging DeepSeek's reasoning capabilities to guide other models through a structured thinking process.](https://github.com/Doriandarko/RAT-retrieval-augmented-thinking)
- Time: 2025/1/29 18:31:56
- Note: 借助 deepseek r1 的思考，强化其他的模型

## [Open Source Mac Apps - Indie Goodies](https://indiegoodies.com/awesome-open-source-mac-apps)
- Time: 2025/1/29 18:57:46
- Note: mac 上的开源应用列表

## [canvg/canvg: JavaScript SVG parser and renderer on Canvas](https://github.com/canvg/canvg)
- Time: 2025/1/31 09:19:25
- Note: canvg 是一个 JavaScript SVG 解析器和 Canvas 渲染器。它可以从 SVG 文件的 URL 或 SVG 文件的文本中解析 SVG 内容,并在 Canvas 上渲染结果。它还可用于将 SVG 图像栅格化。

## [Keyword Difficulty: How to Estimate Your Chances to Rank](https://ahrefs.com/blog/keyword-difficulty/#)
- Time: 2025/1/31 14:51:10
- Note: 在 Ahrefs，我们使用一种简单的方法来计算 KD。我们会提取您关键词排名前 10 的页面，并查找有多少网站链接到它们。排名靠前的页面获得的链接越多，其 KD 分数就越高。这种方法非常简单且易于操作。

## [The Gamer and the Nihilist - Components](https://components.one/posts/gamer-and-nihilist-product-hunt)
- Time: 2025/1/31 15:23:54
- Note: product hunt 分析

## [Deepseek R1可能找到了超越人类的办法 | TL;DR](https://mazzzystar.com/2025/01/30/chatgpt-to-deepseek-r1-zh/)
- Time: 2025/1/31 15:59:36
- Note: 将模型对齐到人类品味而非客观真理，似乎就能避开真正残酷的、性能可量化的大模型竞技场。

## [⁡⁣⁤⁣⁡‌‌⁢⁢‍﻿‬⁤‍​‬﻿​​⁢⁣‌⁤​﻿⁤‌‍⁤⁤﻿⁤​​⁣﻿⁡﻿‬﻿⁡⁡‬﻿⁢⁡⁣‍⁣0编程经验，我如何借助Cursor搭建AI出海工具站赚美金 - Feishu Docs](https://tjvomspfav.feishu.cn/docx/WTAxda5tRoC2ZVxCmgtcJiNsnlc?EODM=1)
- Time: 2025/1/31 21:21:31
- Note: 出海工具站思路。
